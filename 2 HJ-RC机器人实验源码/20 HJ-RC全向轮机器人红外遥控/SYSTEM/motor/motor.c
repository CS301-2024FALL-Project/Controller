...
void HJduino_L1run(signed char speed,int time) //左1电机前进
{
 			signed char f_speed = - speed;
	    SetMotorSpeed(1,f_speed);//左1轮  //为负数
...
void HJduino_L2run(signed char speed,int time) //左2电机前进函数
{
		  signed char f_speed = - speed;
...
void HJduino_R1run(signed char speed,int time) //右1电机前进函数
{
 			signed char f_speed = - speed;
...
void HJduino_R2run(signed char speed,int time) //右2电机前进函数
{
		  signed char f_speed = - speed;
			SetMotorSpeed2(0,speed);//右2轮   //为正数
			delay_ms(time);                 //时间为毫秒 
...
void HJduino_L1back(signed char speed,int time) //左1电机后退函数
{
	  signed char u_speed = 100- speed;
	  signed char f_speed = - u_speed;
	  SetMotorSpeed(1,u_speed);//左1轮   //为正数
...
void HJduino_L2back(signed char speed,int time) //左2电机后退函数
{
	  signed char u_speed = 100- speed;
	  signed char f_speed = - u_speed;
...
void HJduino_R1back(signed char speed,int time) //右1电机后退函数
{
	  signed char u_speed = 100- speed;
	  signed char f_speed = - u_speed;
	  SetMotorSpeed(0,f_speed);//右1轮 //为负数
...
void HJduino_R2back(signed char speed,int time) //右2电机后退函数
{
	  signed char u_speed = 100- speed;
	  signed char f_speed = - u_speed;
	  SetMotorSpeed2(0,f_speed);//右2轮 //为负数
...
void HJduino_HJ_ZE_R(signed char speed,int time) //全向轮右移函数
{
		 HJduino_L1run(70,10);//左1前进 	 
		 HJduino_R2run(70,10);//右2前进	
		 HJduino_L2back(70,10);//左2后退
		 HJduino_R1back(70,10);//右1后退  
}
void HJduino_HJ_ZE_L(signed char speed,int time) //全向轮左移函数
{
		 HJduino_L2run(70,10);//左2前进	 	 
		 HJduino_R1run(70,10);//右1前进	
		 HJduino_L1back(70,10);//左1后退
		 HJduino_R2back(70,10);//右2后退  
}
